...
(function() {
  var Neat, Router, aliases, describe, environment, error, express, fs, green, info, lock, lockPath, locked, puts, red, server, trap, unlock, usages, _, _ref, _ref1,
    __slice = [].slice;
  ...
  server = function(pr) {
    ...
    return aliases('server', 's', describe('Runs a server using express.js', cmd = function() {
      var app, args, callback, port, router, routes, _i;
